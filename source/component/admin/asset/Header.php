  ...
  <script type="text/javascript">
    ...
    function drawChart() {
      ...
      var data = google.visualization.arrayToDataTable([
        ...
        <?php
        //PIE CHARTS
        $sql = "SELECT gender AS Gender, COUNT(*) AS Percent FROM students GROUP BY gender";

        $result = mysqli_query($link, $sql);
        while ($row = mysqli_fetch_assoc($result)) {
          echo "['" . $row['Gender'] . "'," . $row['Percent'] . "],";
        }
        ?>
  ...
  <div class="flex h-screen bg-white" :class="{'overflow-hidden': isSideMenuOpen}">
      ...
      <div class="py-4 text-gray-500">
        <div class="">
          <a class="ml-3 text-lg font-bold text-gray-800 " href="#">
            Clever academia </a>|
          <span class="italic text-sm text-<?php echo $primary_color; ?>-600">Admin</span>
        </div>
        <ul class="mt-6">
        ...
        <ul>
          <li class="relative px-6 py-3">
            <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 active:text-red-500" href="students.php">
              <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <li class="relative px-6 py-3">
            <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 active:text-red-500" href="mentors.php">
              <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                <path d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path>
              </svg>
          ...
          <li class="relative px-6 py-3">
            <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 active:text-red-500" href="doctors.php">
              <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                <path d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path>
              </svg>
          ...
          <li class="relative px-6 py-3">
            <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 active:text-red-500" href="resources.php">
              ...
              <span class="ml-4">E-resources</span>
            </a>
          </li>
          <li class="relative px-6 py-3">
            <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 active:text-red-500" href="settings.php">
              <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                <path d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path>
              </svg>
        ...
        <div class="px-6 my-6">
          <button class="flex items-center justify-between w-full px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-<?php echo $primary_color; ?>-600 border border-transparent rounded-lg active:bg-<?php echo $primary_color; ?>-600 hover:bg-<?php echo $primary_color; ?>-700 focus:outline-none focus:shadow-outline-<?php echo $primary_color; ?>">
            Profile
    ...
    <aside class="shadow-lg fixed inset-y-0 z-20 flex-shrink-0 w-64 mt-16 overflow-y-auto bg-white md:hidden transition-all ease-in-out duration-500 delay-100 transform -translate-x-[16rem]" id="closeSideMenu">
      <div class="py-4 text-gray-500">
        ...
        <div class="px-6 my-6">
          <button class="flex items-center justify-between px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-<?php echo $primary_color; ?>-600 border border-transparent rounded-lg active:bg-<?php echo $primary_color; ?>-600 hover:bg-<?php echo $primary_color; ?>-700 focus:outline-none focus:shadow-outline-<?php echo $primary_color; ?>">
            Create account
            <span class="ml-2" aria-hidden="true">+</span>
          </button>
        </div>
      ...
      <header class="z-10 py-4 shadow-md bg-white">
        <div class="container flex items-center justify-between h-full px-6 mx-auto text-<?php echo $primary_color; ?>-600">
          ...
          <div class="flex justify-center flex-1 lg:mr-32 ">
            <div class=" relative w-full max-w-xl mr-6 focus-within:text-<?php echo $primary_color; ?>-500">
              <div class="absolute inset-y-0 flex items-center pl-2">
                <svg class="w-4 h-4" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                  <path fill-rule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clip-rule="evenodd"></path>
                </svg>
              </div>
              <input class="w-full px-4 py-2 pl-8 pr-2 text-sm text-gray-700 placeholder-gray-600 bg-gray-100 border-0 rounded-md focus:placeholder-gray-500 focus:bg-white outline-none focus:outline-2 focus:outline-<?php echo $primary_color; ?>-500" type="text" placeholder="Search" aria-label="Search" />
            </div>
          </div>
          <ul class="flex items-center flex-shrink-0 space-x-6">
            ...
            <!-- Notifications menu -->
            <li class="relative">
              <button class="relative align-middle rounded-md focus:outline-none focus:shadow-outline-<?php echo $primary_color; ?>" @click="toggleNotificationsMenu" @keydown.escape="closeNotificationsMenu" aria-label="Notifications" aria-haspopup="true">
            ...
            <li class="relative dropdown">
              <div onclick="dropdown_menu(this);" class="cursor-pointer text-sm font-medium text-gray-600">
                ...
                <button class="user_icon align-middle rounded-full border-2 border-white outline-1 outline-<?php echo $primary_color; ?>-600 focus:outline-none">
                  <img class="object-cover w-8 h-8 rounded-full" src="<?php echo "../../images/" . $_SESSION['profile']; ?>" src="../../images/placeholder.png" alt="" aria-hidden="true" />
                </button>
              </div>
