...
<div class="student-container container px-6 mx-auto grid relative">
            ...
            <form action="" method="GET" class=" w-96 my-2">
                <div class="flex items-center">
                    ...
                    <input type="text" name="search" value="<?php if (isset($_GET['search'])) {
                                                                echo $_GET['search'];
                                                            } ?>" placeholder="Search counselor" class="text-gray-600 block w-full px-4 py-2 text-sm focus:border-<?php echo $primary_color; ?>-400 focus:outline-none border border-gray-200 rounded ">
                </div>
            </form>
        </div>
            ...
            <table id="example" class="w-full">
                ...
                <tbody>
                    ...
                    if (isset($_GET['search'])) {
                        ...
                        $sql  = "SELECT * FROM doctors WHERE level = 'counselor' AND  CONCAT(fullname,email, address, phone_number,degree) LIKE '%$filtervalues%'  ORDER BY doctor_id ASC;";
    ...
    <div class="modalOpen fade hidden absolute left-1/2 top-4 -translate-x-1/2 w-[700px] mx-auto h-auto outline-none overflow-x-hidden overflow-y-auto z-50 shadow-2xl" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modalOpen_update fade hidden absolute left-1/2 top-4 -translate-x-1/2 w-[700px] mx-auto h-auto outline-none overflow-x-hidden overflow-y-auto z-50 shadow-2xl" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog relative w-auto pointer-events-none  ">
