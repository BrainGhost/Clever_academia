            ...
            <form action="" method="GET" class=" w-96 my-2">
                <div class="flex items-center">
                    ...
                    <input type="text" name="search" value="<?php if (isset($_GET['search'])) {
                                                                echo $_GET['search'];
                                                            } ?>" placeholder="Search mentors" class="text-gray-600 block w-full px-4 py-2 text-sm focus:border-<?php echo $primary_color; ?>-400 focus:outline-none border border-gray-200 rounded ">
                </div>
            </form>
        </div>
            ...
            <table id="example" class="w-full">
                ...
                <tbody>
                    ...
                    if (isset($_GET['search'])) {
                        ...
                        WHERE CONCAT(firstname, lastname, gender, topics, email, graduation_year, address) LIKE '%$filtervalues%'  ORDER BY mentor_id ASC;";
