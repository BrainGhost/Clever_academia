...
<div class="student-container container px-6 mx-auto grid relative">
    ...
    <div class="form mt-4 lg:w-[700px] h-auto outline-none overflow-x-hidden overflow-y-auto z-50" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <form method="post" enctype="multipart/form-data">
                <div class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none">
                    ...
                    <div class="modal-footer flex flex-shrink-0 flex-wrap items-center justify-end p-4 border-t border-gray-200 rounded-b-md">
                        <a href="./resources.php" name="cancel" class="px-6 py-2.5 text-<?php echo $primary_color; ?>-700 font-medium
                        -close
                        text-xs
                        leading-tight
                        uppercase
