  ...
  <div class="flex h-screen bg-white" :class="{'overflow-hidden': isSideMenuOpen}">
    ...
    <aside class="shadow-md z-20 hidden w-64 overflow-y-auto bg-white md:block flex-shrink-0">
      <div class="py-4 text-gray-500">
        ...
        <ul>
          <li class="relative px-6 py-3">
            <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 active:text-red-500" href="./appointments.php">
              <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <aside class="shadow-md fixed inset-y-0 z-20 flex-shrink-0 w-64 mt-16 overflow-y-auto bg-white md:hidden transition-all ease-in-out duration-500 delay-100 transform -translate-x-[16rem]" id="closeSideMenu">
      <div class="py-4 text-gray-500">
        ...
        <ul class="mt-6">
          <li class="relative px-6 py-3">
            <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800" href="./index.php">
              <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                <path d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
              </svg>
              <span class="ml-4">Schedule</span>
        ...
        <ul>
          <li class="relative px-6 py-3">
            <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800" href="./appointments.php">
              <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <ul class="flex items-center flex-shrink-0 space-x-6">
            ...
            <li class="relative dropdown">
              <div onclick="dropdown_menu(this);" class="cursor-pointer text-sm font-medium text-gray-600 select-none">
                ...
                <button class="user_icon pointer-events-none align-middle rounded-full border-2 border-white outline-1 outline-<?php echo $primary_color; ?>-600 focus:outline-none">
