...
<div class="student-container container px-6 mx-auto grid relative">
    ...
    <div class="table mt-4">
        ...
        <div id='recipients' class=" max-w-full rounded bg-white">
            <?php
                                            ...
                                            <tr class='bg-white text-teal-900 font-semibold text-center'>
                                                <td colspan='8'>
                                                    <div class='flex justify-center'>
                                                        <h1 class='bg-teal-50 cursor-pointer border border-emerald-200 rounded-md w-96 py-3 px-4'>You were once a mentor, Contact the admin to enable you for another application</h1>
                                                    </div>
                                                </td>
                                            </tr>
                                            ";
