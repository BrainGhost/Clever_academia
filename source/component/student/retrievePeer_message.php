...
if ($resultCheck > 0) {
    ...
    echo
    "
    <div class='flex justify-center border border-teal-400 mt-10 rounded-xl bg-teal-50 font-bold p-2 text-xs text-teal-700 '>You have not staterd a chat here.</div>
    ";
}
