...
$study_group_id = mysqli_real_escape_string($link, $_GET['joinedGroup']);
...
<div class="student-container container px-6 mx-auto grid relative">
    ...
    <div class="mt-4 flex flex-row-reverse">
        ...
        <div id='recipients' class="w-full rounded shadow-lg bg-white px-10 py-2">
            ...
            <div id="mainSection" class="banner h-96 overflow-y-scroll scrollbar-hide p-16">
                <?php
            ...
            <div class="down">
                <form action="" id="typingArea" class="mt-2 border-t-2 border-gray-100 flex justify-center py-2">
                    ...
                    <input type="text" name="group_sendMessage_id" id="incoming" autocomplete="off" value="<?php echo $study_group_id ?>" hidden />
                    ...
                    <input type="submit" id="sendMessage" name='send' value="send" class='ml-2 px-5 py-2 cursor-pointer flex items-center border border-teal-500 bg-teal-50 rounded-lg  hover:bg-teal-100 text-teal-500 font-medium'>
