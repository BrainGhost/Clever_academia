    ...
    <div class="flex-1 h-full max-w-4xl mx-auto overflow-hidden bg-white rounded-lg shadow-xl">
      <div class="flex flex-col overflow-y-auto md:flex-row">
        <div class="h-32 md:h-auto md:w-1/2 md:flex md:justify-center">
          <img aria-hidden="true" class="object-contain w-full md:w-2/3 h-full" src="../images/man-jumping.png" alt="Office" />
        </div>
          ...
          <div class="w-full">
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
              ...
              <label class="block text-sm">
                ...
                <input name="username" class="<?php echo (!empty($username_err)) ? "border-red-400 focus:border-red-500" : "focus:border-teal-400 border-gray-200"; ?> block tracking-wider w-full mt-1 text-sm  focus:outline-none focus:shadow-outline-teal border rounded px-4 py-2" placeholder="Balibonera_Junior" value="<?php echo $username; ?>" />
                <span class="text-xs text-red-500"><?php echo $username_err; ?></span>
              </label>
              <label class="block mt-4 text-sm">
                <span class="text-gray-700">Email</span>
                <input name="email" class="<?php echo (!empty($email_err)) ? "border-red-400 focus:border-red-500" : "focus:border-teal-400 border-gray-200"; ?> block tracking-wider w-full mt-1 text-sm focus:outline-none focus:shadow-outline-teal border rounded px-4 py-2" placeholder="clevercampus@example.com" type="email" value="<?php echo $email; ?>" />
                <span class="text-xs text-red-500"><?php echo $email_err; ?></span>
              </label>
              <label class="block mt-4 text-sm">
                <span class="text-gray-700">Password</span>
                <input name="password" class="<?php echo (!empty($password_err)) ? "border-red-400 focus:border-red-500" : "focus:border-teal-400 border-gray-200"; ?> block tracking-wider w-full mt-1 text-sm focus:outline-none focus:shadow-outline-teal border rounded px-4 py-2" placeholder="***************" type="password" value="<?php echo $password; ?>" />
                <span class="text-xs text-red-500"><?php echo $password_err; ?></span>
              </label>
              <label class="block mt-4 text-sm">
                <span class="text-gray-700"> Confirm password </span>
                <input name="confirm_password" class="<?php echo (!empty($confirm_password_err)) ? "border-red-400 focus:border-red-500" : "focus:border-teal-400 border-gray-200"; ?> block tracking-wider w-full mt-1 text-sm focus:outline-none focus:shadow-outline-teal border rounded px-4 py-2" placeholder="***************" type="password" value="<?php echo $confirm_password; ?>" />
                <span class="text-xs text-red-500"><?php echo $confirm_password_err; ?></span>
              </label>

              <div class="block mt-6 text-sm">
                <label class="flex items-center">
                  <input type="checkbox" name="checked" id="checkbox-id" class="border-0 focus:ring-0 focus:ring-offset-0 cursor-pointer bg-teal-100 text-teal-600 rounded px-4 py-2" />
              ...
              <input type="submit" class="block cursor-pointer w-full px-4 py-2 mt-4 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 bg-teal-600 border border-transparent rounded-lg active:bg-teal-600 hover:bg-teal-700 focus:outline-none focus:shadow-outline-teal" value="Create account">


              <hr class="my-8" />

              <button class="flex items-center justify-center w-full px-4 py-2 text-sm font-medium leading-5 text-gray-700 transition-colors duration-150 border border-gray-300 rounded-lg active:bg-transparent hover:border-gray-500 focus:border-gray-500 active:text-gray-500 focus:outline-none focus:shadow-outline-gray">
              ...
              <button class="flex items-center justify-center w-full px-4 py-2 mt-4 text-sm font-medium leading-5 text-gray-700 transition-colors duration-150 border border-gray-300 rounded-lg active:bg-transparent hover:border-gray-500 focus:border-gray-500 active:text-gray-500 focus:outline-none focus:shadow-outline-gray">
                <svg class="w-4 h-4 mr-2" aria-hidden="true" viewBox="0 0 24 24" fill="currentColor">
              ...
              <p class="mt-4">
                <a class="text-sm font-medium text-teal-600 hover:underline" href="./index.php">
                  Already have an account? Login
                </a>
              </p>
              <p class="mt-1">
                <a class="text-sm font-medium text-red-500 hover:underline" href="../index.php">
                  back home
                </a>
              </p>
            </form>
